...
import themeColor from "@core/assets/data/themeColor.json";
import { openSidebarHideManager, openHomePageSectionManager, openFontManager } from "@core/utils/modal";
import { sendRegisterProtocol } from "@core/utils/protocol";
