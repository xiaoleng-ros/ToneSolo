...
import { openLyricExclude, openAMLLServer, openFontManager } from "@core/utils/modal";
import { LyricConfig } from "@core/types/desktop-lyric";
import { usePlayerController } from "@core/core/player/PlayerController";
import defaultDesktopLyricConfig from "@core/assets/data/lyricConfig";
