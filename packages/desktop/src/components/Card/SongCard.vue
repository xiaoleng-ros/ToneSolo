...
import { QualityType, type SongType } from "@core/types/main";
import { useStatusStore, useMusicStore, useDataStore, useSettingStore } from "@core/stores";
import { formatNumber } from "@core/utils/helper";
import { openJumpArtist } from "@core/utils/modal";
import { toLikeSong } from "@core/utils/auth";
import { isObject } from "lodash-es";
import { formatTimestamp, msToTime } from "@core/utils/time";
