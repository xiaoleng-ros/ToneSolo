...
const config: Configuration = {
  // 应用程序的唯一标识符
  appId: "com.xiaoleng-ros.tonesolo",
  // 应用程序的产品名称
  productName: "ToneSolo",
  copyright: "Copyright © xiaoleng-ros 2026",
  // 构建资源所在的目录
  directories: {
  ...
  extraResources: [
    // Discord RPC
    {
      from: "native/discord-rpc-for-tonesolo",
      to: "native",
      filter: ["*.node"],
    },
    // SMTC - 仅 Windows
  ...
  linux: {
    ...
    // 维护者信息
    maintainer: "ice-website-2ba.pages.dev",
    // 应用程序类别
