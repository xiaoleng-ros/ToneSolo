...
export default defineConfig(({ mode }) => {
  ...
  const sharedResolve = {
    alias: {
      ...
      "@native": resolve(__dirname, "../../native/smtc-for-tonesolo"),
      "@shared": resolve(__dirname, "../core/src/types/shared.ts"),
    },
  };
    ...
    renderer: {
      ...
      build: {
        ...
        rollupOptions: {
          ...
          output: {
            manualChunks: {
              stores: [resolve(__dirname, "../core/src/stores/data.ts"), resolve(__dirname, "../core/src/stores/index.ts")],
            },
          },
        },
        terserOptions: {
