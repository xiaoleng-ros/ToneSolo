import { h } from "vue";
import type { CoverType, UpdateInfoType, SettingType, SongType } from "@core/types/main";
import { CURRENT_AGREEMENT_VERSION } from "@core/constants/agreement";
import { NScrollbar } from "naive-ui";
import { isLogin } from "./auth";
import { isArray, isFunction } from "lodash-es";
import { useDataStore, useSettingStore } from "@core/stores";
import { getAppContext } from "./context";
import Login from "../../../desktop/src/components/Modal/Login/Login.vue";
import JumpArtist from "../../../desktop/src/components/Modal/JumpArtist.vue";
import UserAgreement from "../../../desktop/src/components/Modal/UserAgreement.vue";
import SongInfoEditor from "../../../desktop/src/components/Modal/SongInfoEditor.vue";
import PlaylistAdd from "../../../desktop/src/components/Modal/PlaylistAdd.vue";
import BatchList from "../../../desktop/src/components/Modal/BatchList.vue";
import CloudMatch from "../../../desktop/src/components/Modal/CloudMatch.vue";
import CreatePlaylist from "../../../desktop/src/components/Modal/CreatePlaylist.vue";
import UpdatePlaylist from "../../../desktop/src/components/Modal/UpdatePlaylist.vue";
import DownloadModal from "../../../desktop/src/components/Modal/DownloadModal.vue";
import MainSetting from "../../../desktop/src/components/Setting/MainSetting.vue";
import UpdateApp from "../../../desktop/src/components/Modal/UpdateApp.vue";
import ExcludeLyrics from "../../../desktop/src/components/Modal/Setting/ExcludeLyrics.vue";
import ChangeRate from "../../../desktop/src/components/Modal/ChangeRate.vue";
import AutoClose from "../../../desktop/src/components/Modal/AutoClose.vue";
import Equalizer from "../../../desktop/src/components/Modal/Equalizer.vue";
import SongUnlockManager from "../../../desktop/src/components/Modal/Setting/SongUnlockManager.vue";
import SidebarHideManager from "../../../desktop/src/components/Modal/Setting/SidebarHideManager.vue";
import HomePageSectionManager from "../../../desktop/src/components/Modal/Setting/HomePageSectionManager.vue";
import CopyLyrics from "../../../desktop/src/components/Modal/CopyLyrics.vue";
import AMLLServer from "../../../desktop/src/components/Modal/Setting/AMLLServer.vue";
import FontManager from "../../../desktop/src/components/Modal/Setting/FontManager.vue";
...
export const openJumpArtist = (data: SongType["artists"], id?: number) => {
  const { router } = getAppContext();
  // 若 data 为数组且只有一个元素，则直接跳转
  if (isArray(data) && data.length <= 2 && id && router) {
