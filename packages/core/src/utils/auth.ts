...
import type { UserLikeDataType, CoverType, ArtistType, SongType } from "@core/types/main";
import {
  userAccount,
  userDetail,
  userSubcount,
...
import { likeSong } from "@core/api/song";
import { formatCoverList, formatArtistsList, formatSongsList } from "@core/utils/format";
import { useDataStore, useMusicStore } from "@core/stores";
import { logout, refreshLogin } from "@core/api/login";
import { debounce, isFunction } from "lodash-es";
import { isBeforeSixAM } from "./time";
import { dailyRecommend } from "@core/api/rec";
import { isElectron } from "./env";
import { likePlaylist, playlistTracks } from "@core/api/playlist";
import { likeArtist } from "@core/api/artist";
import { likeAlbum } from "@core/api/album";
import { radioSub } from "@core/api/radio";
