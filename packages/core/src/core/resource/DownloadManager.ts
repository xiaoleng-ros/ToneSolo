import type { SongType, SongLevelType } from "@core/types/main";
import { useDataStore, useSettingStore } from "@core/stores";
import { isElectron } from "@core/utils/env";
import { saveAs } from "file-saver";
import { cloneDeep } from "lodash-es";
import { songDownloadUrl, songLyric, songUrl } from "@core/api/song";
import { songLevelData } from "@core/utils/meta";
import { getPlayerInfoObj } from "@core/utils/format";
