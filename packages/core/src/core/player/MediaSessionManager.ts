...
import { useMusicStore, useSettingStore } from "@core/stores";
import { getPlaySongData } from "@core/utils/format";
import { isElectron, isWin } from "@core/utils/env";
import { msToS } from "@core/utils/time";
import { type SmtcEvent } from "@native";
import { usePlayerController } from "./PlayerController";
import { SmtcEventType, PlaybackStatus } from "@core/types/smtc";
import {
  sendSmtcMetadata,
  sendSmtcTimeline,
  sendSmtcPlayState,
