import { songLyric, songLyricTTML } from "@core/api/song";
import { qqMusicMatch } from "@core/api/qqmusic";
import { keywords as defaultKeywords, regexes as defaultRegexes } from "@core/assets/data/exclude";
import { useCacheManager } from "@core/core/resource/CacheManager";
import { useMusicStore, useSettingStore, useStatusStore } from "@core/stores";
import { type SongLyric } from "@core/types/lyric";
import { isElectron } from "@core/utils/env";
import { stripLyricMetadata } from "@core/utils/lyricStripper";
